...
public class AdminHomeActivity extends AppCompatActivity {
    ...
    private String name;
    private Button buttonSetCode, buttonUsersOverview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = getIntent().getStringExtra("leadster");

        buttonSetCode = findViewById(R.id.SetCode);
        buttonUsersOverview = findViewById(R.id.UsersOverview);
        ...
        buttonSetCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AdminHomeActivity.this, SetCodeActivity.class));
            }
        });

        buttonUsersOverview.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AdminHomeActivity.this, OverviewActivity.class));
            }
        });
